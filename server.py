...
async def game_session_1v1(player1, player2):
    ...
    try:
        ...
        await send_pickle(player1.writer, pickle.dumps({'color': 'blue', 'map': map_final, 'players': [player1.username, player2.username]}))
        await send_pickle(player2.writer, pickle.dumps({'color': 'red', 'map': map_final, 'players': [player1.username, player2.username]}))
...
async def game_session_2v2(player1, player2, player3, player4):
    ...
    try:
        map_final = random.randint(1, 15)
        await send_pickle(player1.writer, pickle.dumps({'color': 'blue', 'map': map_final, 'players': [player1.username, player2.username, player3.username, player4.username]}))
        await send_pickle(player2.writer, pickle.dumps({'color': 'blue', 'map': map_final, 'players': [player1.username, player2.username, player3.username, player4.username]}))
        await send_pickle(player3.writer, pickle.dumps({'color': 'red', 'map': map_final, 'players': [player1.username, player2.username, player3.username, player4.username]}))
        await send_pickle(player4.writer, pickle.dumps({'color': 'red', 'map': map_final, 'players': [player1.username, player2.username, player3.username, player4.username]}))
